define(function () {
    ...
    class BlockTex {
        ...
        loadAtlasTex() {
            ...
            return new Promise((resolve, reject) => {
                ...
                this.image.onload = () => {
                    ...
                    current.props.width = contextTex.canvas.width
                    current.props.height = contextTex.canvas.height
        ...
        getPosition(position) {
            ...
            const numBlockTex = this.props.width / BLOCKTEX_SIZE
            var pixels = []
            var iX = 0
            do {
